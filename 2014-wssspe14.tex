...
datathons is to quickly make progress on a problem by gathering a
group of people together to work in a focused, coherent way on one or
more projects
(http://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-15-S14-S7).
In this case, we took advantage of the distributed nature of the
Mozilla event to recruit participants globally, with no travel required.
We also decided not to focus on expert scientists or developers, but rather
on participants who were interested in but perhaps not engaged in open science
or open source practices.  In this, our event bore some similarity to the
Google Summer of Code (http://delivery.acm.org/10.1145/2670000/2660420/p111-trainer.pdf) but was much shorter and involved more people focusing on a single
project.

% for discussion wrt references from reviewer 1,
% focus on community-style OSS projects, where no formal collaboration
%  is expected;
% this was a largely remote experience, unlike most of the others;
%  GSoC most relevant: http://delivery.acm.org/10.1145/2670000/2660420/p111-trainer.pdf
% 
